...
public class UsuarioService {
	...
	/*Cria um objeto que receberá um novo criptografar senha, pois já existe um padrão na estrutura original, 
	 * o senhaencoder receberá a senha criptografada (a criptografia ocorre no enconder), e retornará a senha criptografada.*/
